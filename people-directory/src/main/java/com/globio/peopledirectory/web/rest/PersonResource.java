...
import com.globio.peopledirectory.domain.Person;
import com.globio.peopledirectory.service.PersonService;
...
/**
 * REST controller for managing {@link com.globio.peopledirectory.domain.Person}.
 */
@RestController
@RequestMapping("/api")
